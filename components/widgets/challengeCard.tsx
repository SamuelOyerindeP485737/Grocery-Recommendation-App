...
export default function MyChallengeCard({ChallengeCardData}: ChallengeCardProps) {
    ...
    return(
        <div className={`relative bg-[url(${ChallengeCardData.image})] bg-cover shadow-[0_0_15px_rgba(0,0,0,0.20)] w-120 flex flex-row rounded-[1.4375rem] shrink-0 hover:scale-102 transition-all duration-100 text-white p-2.5 h-70`}>
                <div className="absolute inset-0 bg-black/40 rounded-[1.4375rem]"></div>
                <div className="z-10 w-[70%] flex flex-col justify-end gap-3 mb-3">
                ...
                <div className="z-10 w-[30%] flex flex-col justify-end">
