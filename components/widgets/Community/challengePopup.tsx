...
import {ChallengeType} from "@/components/widgets/challengeCard";
...
export type challengePopupPageType = {
    ChallengePopupPageNumber: number
}

export type ChangeChallengePopupPage = {
    ChangeChallengePageNumber: (pageNumber: number) => void;
}
...
type MealPopupProps = challengePopupStateData & ChangeChallengePopup & challengeDataType
export default function MyChallengePopup({challengePopupStates, ChangeChallengeState, challengeData} : MealPopupProps) {
    return(
