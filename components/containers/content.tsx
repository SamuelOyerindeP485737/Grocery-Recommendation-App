...
export function MyContent({chatbarState, sidebarState, ChangedSidebarState, ChangedChatbarState, contentData, PageNumber} : MyContentProps) {
    ...
    const costBtnClassList = classNames({"bg-[var(--inverted-active-bg)] text-white":currentPage == "Cost","hover:bg-[var(--button-hover)] bg-[var(--button-inactive-bg)]":currentPage !== "Cost"},"px-4","py-2","rounded-full")
    const ExpBtnClassList = classNames({"bg-[var(--inverted-active-bg)] text-white":currentPage == "Expiry dates","hover:bg-[var(--button-hover)] bg-[var(--button-inactive-bg)]":currentPage !== "Expiry dates"},"px-4","py-2","rounded-full")
    return (
            ...
            <div className="h-[50%]">
                ...
                <div className="p-3 h-fit flex gap-auto justify-between">
                    <div className="flex flex-row gap-3 items-center">
                        <button onClick={toggleSidebarState} className={sidebarState ? "hidden" : " border-1 border-[var(--border-color)] bg-[var(--button-inactive-bg)] rounded-full p-2 aspect-square hover:bg-[var(--sidebar-hover)] active:bg-[var(--sidebar-active)]"}>
                    ...
                    <div className="flex gap-3">
                        ...
                        <button onClick={toggleChatbarState} className={chatbarState ? "hidden" : "bg-[var(--button-inactive-bg)] justify-end align-left border-1 border-[var(--border-color)] rounded-full p-1.5 aspect-square hover:bg-[var(--sidebar-hover)]"}>
